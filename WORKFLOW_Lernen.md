...
| Aspektpaar-Zuordnung | ✅ fertig | `Code/4_Lernen/lernen-aspektpaare.html` | `vokabeln_flat.json` (`par_id`, `aspekt`) | 85 Paare (`ap01`–`ap85`, lückenlos), 3 Sets: A1–A2 (50) / B1–C1 (35) / alle (85) |
