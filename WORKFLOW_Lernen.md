...
| Aspektpaar-Zuordnung | ✅ fertig | `Code/4_Lernen/lernen-aspektpaare.html` | `vokabeln_flat.json` (`par_id`, `aspekt`) | 44 Paare (`ap01`–`ap45`, `ap41` unbelegt), 3 Sets: A1–A2 (16) / B1–C1 (28) / alle (44) |
